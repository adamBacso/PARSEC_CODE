...
void loop(){
    ...
    String plainData = String(temperature) + "," + String(humidity) + "," + String(pressure) + "," + String(ax) + "," + String(ay) + "," + String(az) + "," + String(gx) + "," + String(gy) + "," + String(gz) + "," + String(temp) + "," + String(sgp.measureRaw(temperature,humidity)) + "," + String(vocIndex)+","+String(tempmonGetTemp());
